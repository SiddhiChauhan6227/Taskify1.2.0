...
//                 double contentHeight = _calculateDynamicHeight(state, value);
//
...
//                         // Using dynamic height instead of fixed values
//                         height: widget.isReverse ? 260.h : contentHeight,
...
//                               SizedBox(height: 10),
//                               widget.type == "project"
//                                   ? _buildProjectDonutChart(state)
//                                   : _buildTaskDonutChart(state),
//                             ],
//                           ),
//                         )
//                             : Padding(
...
//                               SizedBox(height: 10),
//                               widget.type == "project"
//                                   ? _buildProjectBarChart(state)
//                                   : _buildTaskBarChart(state),
//                             ],
//                           ),
//                         )
//                             : Padding(
...
//                               ),
//                               isBarChart.value
//                                   ? _buildReverseTodoDonutChart(todoStats, context)
//                                   : _buildReverseTodoBarChart(todoStats)
//                             ],
//                           ),
//                         )),
//                   ),
...
//   }
//
//   // Helper method to calculate dynamic height based on content
//   double _calculateDynamicHeight(DashBoardStatsSuccess state, bool isPieChart) {
//     // Base height for the chart container
//     double baseHeight = 150.h;
//
//     // Add height for title and padding
//     double titleHeight = 50.h;
//
//     // Calculate legend height based on number of items
//     int itemCount = widget.type == "project"
//         ? state.statusWiseProject.length
//         : state.statusWiseTask.length;
//
//     // Approximate height per legend item
//     double itemHeight = 25.h;
//
//     // Maximum items to show without scrolling
//     int maxVisibleItems = 8;
//
//     // Calculate legend height (capped at maxVisibleItems * itemHeight)
//     double legendHeight = math.min(itemCount, maxVisibleItems) * itemHeight;
//
//     // Add some extra space for chart and spacing between elements
//     double spacingHeight = 60.h;
//
//     // Calculate total height
//     double totalHeight = baseHeight + titleHeight + legendHeight + spacingHeight;
//
//     // Adjust height based on chart type
//     return isPieChart ? totalHeight : totalHeight + 20.h;
//   }
//
//   // Extracted widgets for better organization and readability
//   Widget _buildProjectDonutChart(DashBoardStatsSuccess state) {
//     bool isAllZero = state.statusWiseProject.every((project) => project.totalProjects == 0);
//
//     return Column(
//       mainAxisSize: MainAxisSize.min,
...
//           height: 170.h,
//           child: Stack(
//             alignment: Alignment.center, // Center aligns text inside the chart
//             children: [
//               SfCircularChart(
//                 series: <CircularSeries>[
//                   isAllZero
//                       ? DoughnutSeries<StatusWiseProjects, String>(
//                     dataSource: [
//                       StatusWiseProjects(
//                         title: "No Data",
//                         totalProjects: 1,
//                         chartcolor: "0xFFD3D3D3",
//                       )
//                     ],
//                     xValueMapper: (StatusWiseProjects data, _) => data.title,
//                     yValueMapper: (StatusWiseProjects data, _) => data.totalProjects,
//                     pointColorMapper: (StatusWiseProjects data, _) => Colors.transparent,
//                     strokeColor: Colors.grey, // Outline color
//                     strokeWidth: 2, // Bordered style
//                     dataLabelSettings: DataLabelSettings(isVisible: false), // Hide labels
//                     innerRadius: getResponsiveRadius(60),
//                     radius: getResponsiveRadius(60),
//                   )
//                       : DoughnutSeries<StatusWiseProjects, String>(
//                     dataSource: state.statusWiseProject,
//                     xValueMapper: (StatusWiseProjects data, _) => data.title,
//                     yValueMapper: (StatusWiseProjects data, _) => data.totalProjects,
//                     pointColorMapper: (StatusWiseProjects data, _) =>
//                         hexToColor(data.chartcolor!),
//                     explode: true,
//                     explodeIndex: 2,
...
//               ),
//
//               // Show "0" in the center if all values are 0
//               if (isAllZero)
//                 Text(
//                   "0",
//                   style: TextStyle(
...
//         SizedBox(
//           width: 150.w,
//           child: _buildProjectLegend(state),
//         ),
//       ],
//     );
//   }
//
//
//   Widget _buildTaskDonutChart(DashBoardStatsSuccess state) {
//     return Column(
//       mainAxisSize: MainAxisSize.min,
//       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//       children: [
...
//           height: 170.h,
//           child: Stack(
//             alignment: Alignment.center, // Center the text inside the chart
//             children: [
//               SfCircularChart(
//                 title: ChartTitle(text: ""),
//                 series: <CircularSeries>[
//                   // Check if all values are 0
//                   state.statusWiseTask.every((task) => task.totalTasks == 0)
//                       ? DoughnutSeries<StatusWiseTasks, String>(
//                     dataSource: [
//                       StatusWiseTasks(
//                         title: "No Data",
//                         totalTasks: 1,
//                         chart_color: "0xFFD3D3D3",
//                       )
//                     ],
//                     xValueMapper: (StatusWiseTasks data, _) => data.title,
//                     yValueMapper: (StatusWiseTasks data, _) => data.totalTasks,
//                     pointColorMapper: (StatusWiseTasks data, _) => Colors.transparent,
//                     strokeColor: Colors.grey, // Outline color
//                     strokeWidth: 2, // Bordered style
//                     dataLabelSettings: DataLabelSettings(
//                       isVisible: false, // Hide labels for empty state
//                     ),
//                     innerRadius: getResponsiveRadius(60),
//                     radius: getResponsiveRadius(60),
//                   )
//                       : DoughnutSeries<StatusWiseTasks, String>(
//                     dataSource: state.statusWiseTask,
//                     xValueMapper: (StatusWiseTasks data, _) => data.title,
//                     yValueMapper: (StatusWiseTasks data, _) => data.totalTasks,
//                     pointColorMapper: (StatusWiseTasks data, _) =>
//                         hexToColor(data.chart_color!),
//                     explode: true,
//                     explodeIndex: 2,
//                     dataLabelSettings: DataLabelSettings(
//                       labelIntersectAction: LabelIntersectAction.shift,
...
//               ),
//
//               // Show "0" in the center when all values are 0
//               if (state.statusWiseTask.every((task) => task.totalTasks == 0))
//                 Text(
//                   "0",
//                   style: TextStyle(
//                     fontSize: 14.sp,
...
//   }
//
//   Widget _buildProjectBarChart(DashBoardStatsSuccess state) {
//     return Column(
//       mainAxisSize: MainAxisSize.min,
//       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//       children: [
...
//               ColumnSeries<StatusWiseProjects, String>(
//                 dataSource: state.statusWiseProject,
//                 xValueMapper: (StatusWiseProjects data, _) => data.title,
//                 yValueMapper: (StatusWiseProjects data, _) => data.totalProjects,
...
//   }
//
//   Widget _buildTaskBarChart(DashBoardStatsSuccess state) {
//     return Column(
//       mainAxisSize: MainAxisSize.min,
//       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//       children: [
...
//             ),
//             series: <CartesianSeries<dynamic, dynamic>>[
//               ColumnSeries<StatusWiseTasks, String>(
//                 dataSource: state.statusWiseTask,
//                 xValueMapper: (StatusWiseTasks data, _) => data.title,
//                 yValueMapper: (StatusWiseTasks data, _) => data.totalTasks,
//                 borderRadius: BorderRadius.only(
...
//   }
//
//   Widget _buildReverseTodoDonutChart(List<StatusWiseProjects> todoStats, BuildContext context) {
//     bool isAllZero = todoStats.every((todo) => todo.totalProjects == 0);
//
//     return Padding(
...
//                       yValueMapper: (StatusWiseProjects data, _) => data.totalProjects,
//                       pointColorMapper: (StatusWiseProjects data, _) =>
//                       data.title == "Completed Todos" ? Colors.green : Colors.red,
//                       explode: true,
//                       explodeIndex: 1,
//                       dataLabelSettings: DataLabelSettings(
//                         labelIntersectAction: LabelIntersectAction.shift,
...
//
//
//   Widget _buildReverseTodoBarChart(List<StatusWiseProjects> todoStats) {
//     return Column(
//       mainAxisSize: MainAxisSize.min,
//       children: [
//         SizedBox(
...
//   }
//
//   Widget _buildTaskLegend(DashBoardStatsSuccess state) {
...
//                       ConstrainedBox(
//                         constraints: BoxConstraints(
//                           maxWidth: 150.w, // Limits text width
//                         ),
//                         child: Text(
//                           taskStats.title!,
//                           maxLines: 1,
...
//
//
//   Widget _buildProjectLegend(DashBoardStatsSuccess state) {
//     return IntrinsicHeight( // Makes the Container take the height of the content
//       child: Column(
//         mainAxisSize: MainAxisSize.min, // Ensures Column only takes necessary height
//         children: [
//           Wrap( // Wrap ensures content wraps naturally
//             children: List.generate(
//               state.statusWiseProject.length,
//                   (index) {
//                 StatusWiseProjects projectStats = state.statusWiseProject[index];
//                 return Padding(
//                   padding: EdgeInsets.symmetric(vertical: 4.h), // Adds spacing between rows
//                   child: Row(
//                     mainAxisSize: MainAxisSize.min,
//                     children: [
//                       Container(
